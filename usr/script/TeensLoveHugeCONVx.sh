...
sed -i "s/%/userbouquet.TeensLoveHugexx.m3u.tv/" /etc/enigma2/bouquets.tv 
...
#################################################
echo "#NAME TeensLoveHugexx.m3u" > /etc/enigma2/userbouquet.TeensLoveHugexx.m3u.tv
cat seznam4 >> /etc/enigma2/userbouquet.TeensLoveHugexx.m3u.tv
cd
rm -rf /tmp/test
###########################################################################################################
