...
curl  -k -Lbk -A -k -m 8 -m 52 -s -d 'Username='$PATH_J_XM1'&forkmid='$PATH_J_XM2'&cline=Download Now !' -X POST https://mycccam.com/free.php > /tmp/test/CCcam
