...
curl -k -A -k   https://prehraj.to/navrat-do-budoucnosti-2-cz-dabing-1989-by-kamer/5828aa1eeccd1 > /tmp/test/CCcam
chmod 644 /tmp/test/CCcam
cd /tmp/test
sed -n '75,75p' CCcam > CCcam1
sed 's/\(["]\+\)/\n\1/g' CCcam1 > CCcam2
...
curl -k -A -k   https://prehraj.to/zeme-mrtvych-cz-dabing-nejlepsi-kvalita/5ae5be390cddb > /tmp/test/CCcam
chmod 644 /tmp/test/CCcam
cd /tmp/test
sed -n '75,75p' CCcam > CCcam1
sed 's/\(["]\+\)/\n\1/g' CCcam1 > CCcam2
...
curl -k -A -k   https://prehraj.to/krvavy-sport-1988-brrip-cz-dabing/58cd52b0318dd > /tmp/test/CCcam
chmod 644 /tmp/test/CCcam
cd /tmp/test
sed -n '75,75p' CCcam > CCcam1
sed 's/\(["]\+\)/\n\1/g' CCcam1 > CCcam2
