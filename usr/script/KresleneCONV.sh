#!/bin/sh
sleep 1
echo "stahuji stream list SKTonline ..Kreslené"
sleep 2
...
#################################################
curl  -k -Lbk -m 55532 -m 555104 "http://online.sktorrent.eu/videos/rozpravky-cz-sk-kreslene-animovane?o=mv" > /tmp/test/a
grep -o -i '<a href="/video/[^<]*' /tmp/test/a > /tmp/test/a1
curl  -k -Lbk -m 55532 -m 555104 "http://online.sktorrent.eu/videos/rozpravky-cz-sk-kreslene-animovane?o=mv&page=2" > /tmp/test/b
...
#################################################
curl  -k -Lbk -m 55532 -m 555104 "http://online.sktorrent.eu/videos/rozpravky-cz-sk-kreslene-animovane?o=mv&page=3" > /tmp/test/a
grep -o -i '<a href="/video/[^<]*' /tmp/test/a > /tmp/test/a1
curl  -k -Lbk -m 55532 -m 555104 "http://online.sktorrent.eu/videos/rozpravky-cz-sk-kreslene-animovane?o=mv&page=4" > /tmp/test/b
grep -o -i '<a href="/video/[^<]*' /tmp/test/b > /tmp/test/b1
cat /tmp/test/a1 /tmp/test/b1 > /tmp/test/c
grep -o -i '/video[^<]*' /tmp/test/c  > /tmp/test/c1
cut -d '"' -f 1  /tmp/test/c1 > /tmp/test/www
...
#################################################
#################################################
cp /tmp/film.m3u /movie/Kreslene72.m3u
cd
rm -rf /tmp/test
#################################################
[ -d /tmp/test ] || mkdir -p /tmp/test
...
sed -i "s/%/userbouquet.Kreslene72.m3u.tv/" /etc/enigma2/bouquets.tv 
...
echo "#NAME Kreslene72.m3u" > /etc/enigma2/userbouquet.Kreslene72.m3u.tv
cat /tmp/test/Rus10.m3u >> /etc/enigma2/userbouquet.Kreslene72.m3u.tv
rm -rf /tmp/test
cd /
