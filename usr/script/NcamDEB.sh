...
cd /tmp
curl  -k -Lbk -m 55532 -m 555104 "https://drive.google.com/uc?id=1Riukc7Zp_yZWeY2xE4cdB41jMaKNZYOy&export=download" > /tmp/enigma2-plugin-softcams-ncam-osdreambox_V10.0-r0.deb
sleep 1
echo "instaluji Ncam...."
cd /tmp
